...
$options = array(
	...
	'timeline' => array(
		...
		'timeline_text_options_title' => array(
			'title'    => _x( 'Timeline Text Customization', 'Panel: section title', 'yith-woocommerce-multi-step-checkout' ),
		...
		'timeline_text_option_separator' => array(
			...
			'desc'    => _x( "Enter the separator element for steps. You can use / or - for example or leave empty if you don't want a separator element", 'Admin: option description', 'yith-woocommerce-multi-step-checkout' ),
			'default' => '/'
		),

		'timeline_text_options_end' => array(
			'type' => 'sectionend',
		),
