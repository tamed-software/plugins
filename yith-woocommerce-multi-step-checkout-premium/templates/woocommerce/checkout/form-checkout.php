...
$default_login_message = get_option( 'yith_wcms_form_checkout_login_message', _x( 'If you have already registered, please, enter your details below. If you are a new customer, please, go to the Billing &amp; Shipping section.', '[Frontend] Message for returning customer on checkout page', 'yith-woocommerce-multi-step-checkout' ) );
        ...
        <form name="checkout" method="post" class="checkout woocommerce-checkout processing" action="<?php echo esc_url( $get_checkout_url ); ?>" enctype="multipart/form-data">
            ...
            <div id="order_review" class="woocommerce-checkout-review-order">
                ...
                <div id="order_checkout_payment" class="yith-woocommerce-checkout-payment">
                    <h3 id="payment_heading"><?php _e( 'Métodos de pago', 'yith-woocommerce-multi-step-checkout' ); ?></h3>
