					...
					switch( $section ){
						case 'collect_and_store':
							$message = '<p>' . __( 'We collect information about you during the checkout process on our store.', 'yith-woocommerce-multi-step-checkout' ) . '</p>' .
							           ...
							           '<li>' . __( 'Data saved are: your name, billing address, shipping address, email address, phone number, credit card/payment type (no credit card/payment information) and other fields added by 3rd-party plugins
', 'yith-woocommerce-multi-step-checkout' ) . '</li>' .
							           '</ul>';
							break;
