...
if ( ! class_exists( 'SP_WPCP' ) ) {
	class SP_WPCP {
		...
		public static function setup() {
			...
			// 			SP_WPCP_Customize_Options::instance( $key, $params );
			...
			// 			$params['sections']   = self::$args['sections'][ $key ];
			// 			self::$inited[ $key ] = true;
			// 			SP_WPCP_Profile_Options::instance( $key, $params );
			// 		}
			// 	}
			// }
			...
			// 			SP_WPCP_Shortcoder::instance( $key, $params );
			...
			// 		SP_WPCP_Shortcoder::once_editor_setup();
			// 	}
			// }
			...
			// 			SP_WPCP_Taxonomy_Options::instance( $key, $params );
