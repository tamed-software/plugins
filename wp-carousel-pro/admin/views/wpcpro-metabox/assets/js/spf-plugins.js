...
(function(root, factory) {
  ...
  //
  // SPF: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // SPF: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSP_WPCP = FormSerializer.serializeObject;
    $.fn.serializeJSONSP_WPCP   = FormSerializer.serializeJSON;
  }
