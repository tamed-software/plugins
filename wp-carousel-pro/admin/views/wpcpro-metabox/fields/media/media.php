 ...
 *
 */
if( ! class_exists( 'SP_WPCP_Field_media' ) ) {
  class SP_WPCP_Field_media extends SP_WPCP_Fields {
    ...
    public function render() {
      ...
      $placeholder = ( empty( $this->field['placeholder'] ) ) ? ' placeholder="'.  esc_html__( 'No media selected', 'wp-carousel-pro' ) .'"' : '';
