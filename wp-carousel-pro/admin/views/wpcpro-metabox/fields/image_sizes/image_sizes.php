 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'SP_WPCP_Field_image_sizes' ) ) {
	class SP_WPCP_Field_image_sizes extends SP_WPCP_Fields {
		...
		public function render() {
			...
			if ( ! empty( $sizes ) ) {
				...
				if ( ! empty( $sizes ) ) {
					...
					echo ( ! empty( $this->field['empty_message'] ) ) ? $this->field['empty_message'] : esc_html__( 'No image sizes found.', 'wp-carousel-pro' );
