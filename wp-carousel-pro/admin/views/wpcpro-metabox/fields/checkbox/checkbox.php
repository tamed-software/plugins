 ...
 *
 */
if( ! class_exists( 'SP_WPCP_Field_checkbox' ) ) {
  class SP_WPCP_Field_checkbox extends SP_WPCP_Fields {
    ...
    public function render() {
      ...
      if( ! empty( $this->field['options'] ) ) {
        ...
        if( ! empty( $options ) ) {
          ...
          echo ( ! empty( $this->field['empty_message'] ) ) ? $this->field['empty_message'] : esc_html__( 'No data provided for this option type.', 'wp-carousel-pro' );
