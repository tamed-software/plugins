 ...
 *
 */
if( ! class_exists( 'WP_Customize_Panel_SP_WPCP' ) && class_exists( 'WP_Customize_Panel' ) ) {
  class WP_Customize_Panel_SP_WPCP extends WP_Customize_Panel {
    public $type = 'spf';
  }
}
 ...
 *
 */
if( ! class_exists( 'WP_Customize_Section_SP_WPCP' ) && class_exists( 'WP_Customize_Section' ) ) {
  class WP_Customize_Section_SP_WPCP extends WP_Customize_Section {
    public $type = 'spf';
  }
}
 ...
 *
 */
if( ! class_exists( 'WP_Customize_Control_SP_WPCP' ) && class_exists( 'WP_Customize_Control' ) ) {
  class WP_Customize_Control_SP_WPCP extends WP_Customize_Control {
    ...
    public function render_content() {
      ...
      SP_WPCP::field( $this->field, $this->value(), $this->unique, 'customize' );
