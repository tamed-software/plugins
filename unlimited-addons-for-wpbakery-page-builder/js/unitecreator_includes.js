function UniteCreatorIncludes(){
	...
	function initEvents(){
		...
		//add include
		g_objIncludesWrapper.delegate(".uc-includes-add", "click", onAddClick);

		//delete inlcude
		g_objIncludesWrapper.delegate(".uc-includes-delete", "click", onDeleteClick);

		//include settings
		g_objIncludesWrapper.delegate(".uc-includes-settings", "click", openIncludeSettingsDialog);
		
		g_objIncludesWrapper.delegate(".uc-includes-url", "blur", onInputUrlChange);
		g_objIncludesWrapper.delegate(".uc-includes-url", "change", onInputUrlChange);
