...
<div class="woo-slg-social-wrap" style="text-align: center;">

	<?php if( !empty( $networks ) ) { // code to display selected networks only from shortcode
...
<?php 
\WSL\Persistent\WOOSLGPersistent::set('woo_slg_fb_redirect_url', $login_redirect_url);
?>
<?php 
...
if ( function_exists('icl_object_id') && class_exists('SitePress') ) {
    ...
    \WSL\Persistent\WOOSLGPersistent::set('woo_slg_wpml_lang', ICL_LANGUAGE_CODE);
}
?>