...
YITH WooCommerce Badge Management will add a new submenu called "Badge Management" under "YITH" menu. Here you are able to configure all the plugin settings.
