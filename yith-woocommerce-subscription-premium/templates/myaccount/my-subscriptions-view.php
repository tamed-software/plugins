...
?>
<h2><?php echo apply_filters( 'ywsbs_my_account_subscription_title', __( 'Mis suscripciones', 'yith-woocommerce-subscription' ) ); ?></h2>
<?php if( empty( $subscriptions ) ) : ?>
    <p class="ywsbs-my-subscriptions"><?php _e( 'No hay suscripciones activas para tu cuenta.', 'yith-woocommerce-subscription' ) ?></p>
<?php else: ?>
    <table class="shop_table ywsbs_subscription_table my_account_orders">
        <thead>
        <tr>
            <th class="ywsbs-subscription-product"><?php _e( 'Póliza', 'yith-woocommerce-subscription' ); ?></th>
            <th class="ywsbs-subscription-status"><?php _e( 'Estado', 'yith-woocommerce-subscription' ); ?></th>
            <th class="ywsbs-subscription-recurring"><?php _e( 'Frecuencia', 'yith-woocommerce-subscription' ); ?></th>
            <th class="ywsbs-subscription-start-date"><?php _e( 'Fecha de inicio', 'yith-woocommerce-subscription' ); ?></th>
            <th class="ywsbs-subscription-payment-date"><?php _e( 'Siguiente pago', 'yith-woocommerce-subscription' ); ?></th>
