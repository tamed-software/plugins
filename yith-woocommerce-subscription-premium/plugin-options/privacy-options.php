...
$settings = array(
    ...
    'privacy' => array(
            ...
            'erasure_request'   => array(
	            ...
	            'desc-inline'      => __( 'Remove personal data from subscriptions', 'yith-woocommerce-request-a-quote' ),
...
<br>Note: All the subscriptions will change the status to cancelled if the personal data will be removed.', 'yith-woocommerce-request-a-quote' ), esc_url( admin_url( 'tools.php?page=remove_personal_data' ) ) ),
