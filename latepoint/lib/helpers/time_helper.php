...
class OsTimeHelper {
  ...
  public static function get_time_systems_list_for_select(){
    return array( array( 'value' => '12', 'label' => __('12 horas', 'latepoint')), array( 'value' => '24', 'label' => __('24 horas', 'latepoint')));
  }

  
  public static function get_time_systems_list(){
    return array('12' => __('12 horas', 'latepoint'), '24' => __('23 horas', 'latepoint'));
  }
