<div class="latepoint-top-bar-w">
	<div class="latepoint-top-logo">
		<a href="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('dashboard', 'index')); ?>"><img src="<?php echo home_url().'/wp-content/uploads/2019/03/tamed-logo-2017.svg' ?>" alt=""></a>
	</div>
