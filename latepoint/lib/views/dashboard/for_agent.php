<div class="os-row">
	...
	<div class="os-col-4">
		<div class="os-info-tile">
			...
			<div class="os-tile-info">
				<div class="os-tile-label"><?php _e('Necesitan aprovación', 'latepoint'); ?></div>
	...
	<div class="os-col-4">
		<div class="os-widget os-widget-animated">
			<div class="os-widget-header with-actions">
				<h3 class="os-widget-header-text"><?php _e('Por tipo de servicio', 'latepoint'); ?></h3>
			</div>
					...
					<div class="service-type-donut-chart-data">
						...
						<?php foreach($services_count_by_types as $service){ ?>
							<div class="chart-label">
								...
								<div class="value"><?php echo sprintf(__('%d Reuniones', 'latepoint'), $service['count']); ?></div>
							</div>
						<?php } ?>
						</div>
					</div>
			...
			<?php }else{ ?>
			  <div class="no-results-w">
			    ...
			    <a href="#" <?php echo OsBookingHelper::quick_booking_btn_html(); ?> class="latepoint-btn">
			    	...
			    	<span><?php _e('Crear reunión', 'latepoint'); ?></span>
		    	</a>
			  </div>
			<?php } ?>
		</div>
