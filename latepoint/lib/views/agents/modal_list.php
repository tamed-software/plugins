<div class="os-agents-list-w">
  <h3 class="agents-header"><?php _e('Seleccionar Experto', 'latepoint'); ?></h3>
  ...
  <div class="agents-footer" style="display: none;">
    <a href="#" class="latepoint-btn latepoint-btn-secondary cancel-assign-agents"><?php _e('Cancelar', 'latepoint'); ?></a>
    <a href="#" class="latepoint-btn latepoint-btn-primary save-assign-agents" data-service-id="<?php echo $service_id; ?>"><?php _e('Guardar experto', 'latepoint'); ?></a>
  </div>
</div>
<script>
( function( $ ) {
