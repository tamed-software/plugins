<div class="step-verify-w latepoint-step-content">
  <div class="latepoint-step-content-text-left">
    <div><?php _e('Verifica la información de tu cita; puedes volver a editarla o aceptarla al hacer clic en el botón "Confirmar".', 'latepoint'); ?></div>
  </div>
  <div class="confirmation-info-w">
  	<div class="confirmation-app-info">
		  <h5><?php _e('Información de reunión', 'latepoint'); ?></h5>
		  <ul>
        ...
        <?php if(!OsSettingsHelper::is_on('steps_hide_agent_info')){ ?>
    	  	<li><?php _e('Experto:', 'latepoint'); ?> <strong><?php echo $booking->get_agent_full_name(); ?></strong></li>
        <?php } ?>
