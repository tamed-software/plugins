<div class="os-form-w quick-booking-form-w">
  <form action="" data-os-show-errors-as-notification="yes" data-os-action="<?php echo ($booking->is_new_record()) ? OsRouterHelper::build_route_name('bookings', 'create') : OsRouterHelper::build_route_name('bookings', 'update'); ?>" class="booking-quick-edit-form">
    ...
    <div class="os-form-content">
      ...
      <div class="os-row">
        <div class="os-col-6">
          <?php echo OsFormHelper::text_field('booking[start_date]', __('Fecha inicial', 'latepoint'), $booking->start_date, array('class' => 'trigger-quick-availability', 'data-route' => OsRouterHelper::build_route_name('bookings', 'quick_availability'))); ?>
        </div>
        <div class="os-col-6">
          <a href="#" data-route="<?php echo OsRouterHelper::build_route_name('bookings', 'quick_availability'); ?>" class="latepoint-btn latepoint-btn-white open-quick-availability-btn trigger-quick-availability"><i class="latepoint-icon latepoint-icon-calendar"></i><span><?php _e('Mostrar calendario', 'latepoint'); ?></span></a>
        </div>
      </div>
      <div class="os-row">
        <div class="os-col-12">
          <div class="ws-period os-period-transparent">
            <div class="quick-start-time-w">
              <?php echo OsFormHelper::time_field('booking[start_time]', __('Hora inicial', 'latepoint'), $booking->start_time, true); ?>
            </div>
            <div class="quick-end-time-w">
              <?php echo OsFormHelper::time_field('booking[end_time]', __('Hora final', 'latepoint'), $booking->end_time, true); ?>
            </div>
          </div>
        </div>
      </div>
      <div class="os-row">
        ...
        <div class="os-col-6">
          <?php echo OsFormHelper::text_field('booking[buffer_after]', __('Tiempo adicional', 'latepoint'), $booking->buffer_after); ?>
        </div>
      </div>
      <div class="os-row">
        <div class="os-col-12">
      ...
      <div class="customer-info-w selected">
        ...
        <div class="customers-selector-w">
          <div class="customers-selector-search-w">
            ...
            <input type="text" class="customers-selector-search-input" placeholder="<?php _e('Escribe para buscar...', 'latepoint'); ?>">
    ...
    <div class="os-form-buttons">
      <?php 
      echo '<button type="submit" class="latepoint-btn">'.__('Guardar cambios', 'latepoint').'</button>';
      echo '<a href="#" class="latepoint-side-panel-close-trigger latepoint-btn latepoint-btn-secondary">'.__('Cancelar', 'latepoint').'</a>';
