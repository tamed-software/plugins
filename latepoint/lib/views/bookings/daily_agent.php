...
<div class="bookings-daily-agent" data-route="<?php echo OsRouterHelper::build_route_name('bookings', 'daily_agent'); ?>">
		...
		<div class="calendar-daily-agent-w">
			...
			<?php }else{ ?>
			  <div class="no-results-w">
			    ...
			    <a href="<?php echo OsRouterHelper::build_link(OsRouterHelper::build_route_name('settings', 'general')); ?>" class="latepoint-btn"><i class="latepoint-icon latepoint-icon-plus-square"></i><span><?php _e('Editar horas de trabajo', 'latepoint'); ?></span></a>
			  </div>
			<?php } ?>
		</div>
	</div>
	<div class="daily-agent-side">
		<div class="dam-params">
			<h3><?php _e('Calendario', 'latepoint'); ?></h3>
    	...
    	<h3><?php echo __('Servicio disponible para', 'latepoint').' <span>'.$nice_selected_date.'<span>'; ?></h3>
		...
		<div class="os-row">
			<div class="os-col-6">
				<div class="os-info-tile tile-centered">
					...
					<div class="os-tile-info">
						<div class="os-tile-label"><?php _e('Reuniones', 'latepoint'); ?></div>
			...
			<div class="os-col-6">
				<div class="os-info-tile tile-centered">
					...
					<div class="os-tile-info">
						<div class="os-tile-label"><?php _e('Abiertas', 'latepoint'); ?></div>
						<div class="os-tile-desc"><?php echo($nice_selected_date); ?></div>
					</div>
				</div>
			</div>
				...
				<div class="os-row os-row-align-center">
					...
					<div class="os-col-6">
						<div class="service-type-donut-chart-data">
							<h3 class="chart-heading"><?php _e('Tipos de servicio', 'latepoint'); ?></h3>
							...
							<?php foreach($services_count_by_types as $service){ ?>
								<div class="chart-label">
									...
									<div class="value"><?php echo sprintf(__('%d reunión', 'latepoint'), $service['count']); ?></div>
								</div>
							<?php } ?>
						</div>
						</div>
