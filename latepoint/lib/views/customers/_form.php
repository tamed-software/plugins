    ...
    <?php 
      if($customer->is_new_record()){
        ...
        echo '<a href="#" class="latepoint-btn latepoint-btn-danger remove-customer-btn" style="margin-left: auto;" 
                data-os-prompt="'.__('¿Estás seguro de que quieres eliminar a este cliente? Se eliminarán todas las reuniones y transacciones asociadas con este cliente.', 'latepoint').'" 
...
<?php if(!$customer->is_new_record()){ ?>
	<div class="customer-appointments">
		<div class="os-form-sub-header"><h3><?php _e('Reuniones', 'latepoint'); ?></h3></div>
		<?php  
		if($customer->bookings){
		  ...
		  <div class="no-results-w">
		    ...
		    <h2><?php _e('El cliente no tiene reuniones de momento', 'latepoint'); ?></h2>
