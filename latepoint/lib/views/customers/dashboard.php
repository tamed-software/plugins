		...
		<div class="latepoint-tab-content tab-content-customer-bookings active">
			<?php if($customer->future_bookings || $customer->past_bookings){ ?>
				...
				<div class="latepoint-section-heading-w">
					<h5 class="latepoint-section-heading"><?php _e('Próximas reuniones', 'latepoint'); ?></h5>
				...
				<div class="latepoint-section-heading-w">
					<h5 class="latepoint-section-heading"><?php _e('Reuniones pasadas', 'latepoint'); ?></h5>
					<div class="heading-extra"><?php printf( __('%d Reuniones'), count($customer->past_bookings)); ?></div>
				</div>
				<div class="customer-bookings-tiles">
					<?php 
