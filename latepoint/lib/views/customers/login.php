	...
	<div class="os-form-w latepoint-login-form-w">
		...
		<form action="" data-os-action="<?php echo OsRouterHelper::build_route_name('customers', 'do_login'); ?>" data-os-success-action="redirect">
			...
			<div class="os-form-buttons os-flex">
				...
				<a href="#" class="latepoint-btn-link" style="font-size: 10px;" data-os-action="<?php echo OsRouterHelper::build_route_name('customers', 'request_password_reset_token'); ?>" data-os-output-target=".latepoint-login-form-w"><?php _e('Olvidaste tu contraseña?', 'latepoint'); ?></a>
			</div>
		</form>
	</div>
</div>