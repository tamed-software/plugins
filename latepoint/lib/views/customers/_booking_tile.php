<div class="customer-booking status-<?php echo $booking->status; ?>" data-id="<?php echo $booking->id; ?>">
	...
	<div class="customer-booking-info">
		...
		<div class="customer-booking-info-row"><span class="booking-info-label"><?php _e('Experto', 'latepoint'); ?></span><span class="booking-info-value"><?php echo $booking->agent->full_name; ?></span></div>
